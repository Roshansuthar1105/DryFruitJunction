...
export default function OurTeam() {
    return (
        <section className="min-h-screen py-20 bg-gradient-to-br from-orange-50 to-orange-50">
            <div className="max-w-7xl mx-auto px-4">
                <div className="text-center mb-12">
                    <h2 className="text-4xl font-bold text-gray-800">
                        Meet <span className="bg-gradient-to-r from-orange-600 to-orange-600 bg-clip-text text-transparent">Our Team</span>
                    </h2>
