      ...
      <div className="max-w-4xl w-full bg-white rounded-lg shadow-md overflow-hidden">
        <div className="md:flex">
          ...
          <div className="md:w-1/2 p-12">
            <h2 className="text-2xl font-serif font-bold text-orange-900 mb-2">Join Our Family</h2>
            <p className="text-orange-600 mb-8">Create your sweet account</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="firstName" className="block text-sm font-medium text-orange-800 mb-1 cursor-pointer">
                    First Name
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="lastName" className="block text-sm font-medium text-orange-800 mb-1 cursor-pointer">
                    Last Name
                  </label>
                  <input
                    type="text"
              ...
              <div>
                <label htmlFor="confirmPassword" className="block text-sm font-medium text-orange-800 mb-1 cursor-pointer">
                  Confirm Password
                </label>
                <input
                  type="password"
              ...
              <div className="flex items-center">
                <input
                  ...
                  required
                />
                <label htmlFor="terms" className="ml-2 block text-sm text-orange-700 cursor-pointer">
              ...
              <button
                type="submit"
                disabled={loading}
                className="cursor-pointer w-full mt-6 bg-orange-600 text-white py-2 px-4 rounded-md hover:bg-orange-700 transition duration-200 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 disabled:opacity-70"
              >
                {loading ? (
