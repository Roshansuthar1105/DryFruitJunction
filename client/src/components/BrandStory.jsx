      ...
      <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto relative">
        ...
        <div className="p-8">
          ...
          <div className="space-y-6 text-gray-700">
            ...
            <h3 className="text-xl font-bold text-orange-800 mt-8 mb-4">
              Our Signature Sweets
            </h3>
            
            <ul className="space-y-4">
              <li className="flex items-start">
                <span className="bg-orange-100 p-1 rounded-full mr-3 mt-1">
            ...
            <div className="mt-8 p-6 bg-orange-50 rounded-xl">
              <p className="text-center text-orange-900 font-medium italic">
